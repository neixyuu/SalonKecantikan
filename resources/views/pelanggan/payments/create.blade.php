...
@section('content')
    <div class="max-w-2xl mx-auto px-6 py-12">
        ...
        <div class="mb-8 fade-in">
            ...
            <h1 class="font-serif text-4xl text-charcoal">Mohon Selesaikan Pembayaran Anda</h1>
        ...
        <div class="border border-graymedium p-5 mb-6 fade-in" style="background:var(--color-white);">
            ...
            <div class="space-y-2">
                ...
                <div class="flex justify-between items-center border-t border-graymedium pt-2 mt-2">
                    ...
                    <span
                        class="font-serif text-xl text-charcoal font-semibold">{{ $reservation->treatment->formatted_price }}</span>
                </div>
            </div>
        </div>
        ...
        <form method="POST" action="/payments" enctype="multipart/form-data" class="space-y-5 fade-in">
            ...
            <div>
                ...
                <input type="number" id="amount" name="amount" value="{{ old('amount', $reservation->treatment->price) }}"
                    class="form-input {{ $errors->has('amount') ? 'error' : '' }}" min="1" placeholder="250000" required>
                @error('amount')
            ...
            <div>
                ...
                <div class="border-2 border-dashed border-graymedium p-8 text-center cursor-pointer hover:border-tan transition-colors"
                    id="drop-zone" onclick="document.getElementById('proof_image').click()">
                    <svg class="w-8 h-8 mx-auto mb-3 text-charcoal-light" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
