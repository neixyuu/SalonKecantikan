        ...
        <form method="POST" action="/register" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}"
                    class="form-input {{ $errors->has('name') ? 'error' : '' }}" placeholder="Nama Anda" autocomplete="name"
            ...
            <div>
                ...
                <input type="tel" id="phone" name="phone" value="{{ old('phone') }}"
                    class="form-input {{ $errors->has('phone') ? 'error' : '' }}" placeholder="08xxxxxxxxxx" maxlength="13">
                @error('phone')
                    <p class="form-error">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input type="password" id="password" name="password"
                        class="form-input pr-10 {{ $errors->has('password') ? 'error' : '' }}" placeholder="Min. 8 karakter"
            ...
            <div class="p-4 border border-blush" style="background-color: rgba(243,217,212,0.2);">
                <p class="text-xs text-charcoal-light leading-relaxed">
                    <span class="font-semibold text-tan-dark">Catatan:</span> Setelah mendaftar, akun Anda akan dalam status
                    <strong>menunggu verifikasi</strong> hingga disetujui oleh admin kami.
                </p>
            </div>
