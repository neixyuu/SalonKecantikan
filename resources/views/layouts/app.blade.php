...
<head>
    ...
    <meta name="description"
        content="@yield('meta_description', 'Salon kecantikan premium dengan layanan terbaik untuk merawat kecantikan Anda.')">
    ...
    @if(auth()->check() && auth()->user()->isAdmin())
        ...
        <div class="flex">
            ...
            <aside id="admin-sidebar" class="admin-sidebar">
                ...
                <nav class="py-4">
                    ...
                    <a href="/admin/reservations"
                        class="sidebar-link {{ request()->is('admin/reservations*') ? 'active' : '' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                    ...
                    <a href="/admin/announcements"
                        class="sidebar-link {{ request()->is('admin/announcements*') ? 'active' : '' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                    ...
                    <a href="/admin/treatments"
                        class="sidebar-link {{ request()->is('admin/treatments*') ? 'active' : '' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
            ...
            <main class="admin-content flex-1">
                {{-- Top bar --}}
                <header
                    class="bg-white border-b border-graymedium px-6 py-4 flex items-center justify-between sticky top-0 z-20">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="w-8 h-8 rounded-full bg-blush flex items-center justify-center">
                            <span
                                class="text-charcoal text-xs font-semibold">{{ substr(auth()->user()->name, 0, 1) }}</span>
                        </div>
                    </div>
                </header>
        ...
        <nav class="navbar">
            <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <a href="/" class="flex flex-col leading-none">
                    ...
                    <span class="text-xs tracking-widest uppercase text-tan-dark"
                        style="font-size:0.55rem; letter-spacing:0.18em;">Beauty & Care</span>
                </a>
                ...
                <div class="hidden md:flex items-center gap-8">
                    @auth
                        ...
                        <a href="/reservations"
                            class="nav-link {{ request()->is('reservations*') ? 'active' : '' }}">Reservasi</a>
                ...
                <div class="flex items-center gap-4">
                    @auth
                        ...
                        <div class="relative group">
                            <button
                                class="flex items-center gap-2 text-xs tracking-widest uppercase text-charcoal-light hover:text-charcoal transition-colors">
                            ...
                            <div
                                ...
                                <form method="POST" action="/logout">
                                    @csrf
                                    <button type="submit"
                                        class="w-full text-left px-4 py-2.5 text-xs tracking-wide uppercase hover:bg-graylight text-charcoal-light hover:text-charcoal transition-colors">Logout</button>
                                </form>
                            </div>
                        </div>
                    @else
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="text-sm leading-relaxed text-cream/60 max-w-xs">
                            AETH Clinic — klinik kecantikan premium yang menghadirkan perawatan terbaik untuk merawat dan
                            memperindah kecantikan alami Anda.
                        </p>
                        <div class="mt-6 flex gap-3">
                            <a href="#"
                                class="w-8 h-8 border border-cream/20 flex items-center justify-center hover:border-tan hover:text-tan transition-colors">
                                <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                                        d="M24 4.6a10 10 0 01-2.9.8 5 5 0 002.2-2.8c-1 .6-2.1 1-3.2 1.2a5 5 0 00-8.5 4.6A14.1 14.1 0 011.6 3.2a5 5 0 001.5 6.7 5 5 0 01-2.2-.6v.1a5 5 0 004 4.9 5 5 0 01-2.2.1 5 5 0 004.7 3.5A10 10 0 010 19.5a14.1 14.1 0 007.6 2.2c9.1 0 14-7.5 14-14v-.6c1-.7 1.8-1.6 2.4-2.5z" />
                                </svg>
                            </a>
                            <a href="#"
                                class="w-8 h-8 border border-cream/20 flex items-center justify-center hover:border-tan hover:text-tan transition-colors">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2.5">
                            <li><a href="/treatments" class="text-xs hover:text-tan transition-colors">Facial Treatment</a>
                            </li>
                            <li><a href="/treatments" class="text-xs hover:text-tan transition-colors">Body Massage</a></li>
                            <li><a href="/treatments" class="text-xs hover:text-tan transition-colors">Hair Treatment</a>
                            </li>
                            <li><a href="/treatments" class="text-xs hover:text-tan transition-colors">Manikur & Pedikur</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2.5">
                            ...
                            <li><a href="/announcements" class="text-xs hover:text-tan transition-colors">Pengumuman</a>
                            </li>
